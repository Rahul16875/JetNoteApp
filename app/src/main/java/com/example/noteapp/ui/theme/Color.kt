...
val md_theme_light_surfaceVariant = Color(0xFFE9D7F7)
...
val md_theme_dark_background = Color(0xFF100808)
val md_theme_dark_onBackground = Color(0xFFE4E1E6)
// for changing drawer color
val md_theme_dark_surface = Color(0xFF2B1B1B)
val md_theme_dark_onSurface = Color(0xFFE4E1E6)
// for changing top bar color
val md_theme_dark_surfaceVariant = Color(0xFF4C3D39)
...
val md_theme_dark_outlineVariant = Color(0xFFBEBBBB)
// drawer menu kholne par ye color change karne se background color change hoga
